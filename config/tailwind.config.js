  ...
  theme: {
    extend: {
      colors: {
        ...
        'df-primary': 'rgba(20, 184, 166, 1)',
        'df-primary-hover': 'rgba(13, 148, 136, 1)',
        'df-primary-active': 'rgba(15, 118, 110, 1)',
        ...
        'df-success': 'rgba(20, 184, 166, 1)',
        'df-warning': 'rgba(168, 75, 47, 1)',
        'df-info': 'rgba(98, 108, 113, 1)',
        'df-focus-ring': 'rgba(20, 184, 166, 0.4)',
      },
      fontFamily: {

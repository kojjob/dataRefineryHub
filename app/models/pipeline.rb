...
class Pipeline < ApplicationRecord
  ...
  def retry_policy_object=(retry_value_object)
    if retry_value_object.nil?
      ...
      self.retry_backoff_strategy = nil
      self.retry_initial_delay = nil
      self.retry_max_delay = nil
      self.retry_multiplier = nil
    else
      self.retry_max_attempts = retry_value_object.max_attempts
      self.retry_backoff_strategy = retry_value_object.backoff_strategy
      self.retry_initial_delay = retry_value_object.initial_delay
      self.retry_max_delay = retry_value_object.max_delay
      self.retry_multiplier = retry_value_object.multiplier
    end
    @retry_policy_object = retry_value_object
  end
  ...
  def to_orchestration_config
    {
      ...
      error_handling: {
        ...
        max_failures: retry_policy_object&.max_attempts || 3,
        recovery_time: (retry_policy_object&.initial_delay || 600).seconds
      },
